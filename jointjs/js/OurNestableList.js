class OurNestableListNode extends AbstractBase
{
  constructor(props)
  {
    super(props);
...
class OurNestableListBody extends AbstractBase
{
  constructor(props)
  {
    super(props);
  ...
  sortData(a, b)
  {
    var cmp1 = this.state.data[a];
    var cmp2 = this.state.data[b];
  ...
  render()
  {
    ...
    if (Object.keys(this.state.data).length > 0) {
      ...
      var sorted = Object.keys(this.state.data).sort(this.sortData.bind(this));
    ...
    return (
      <ol key="body" className="dd-list">{rows}</ol>
    )
  }
}

class OurNestableList extends AbstractBase
{
  constructor(props)
  {
    super(props);
    ...
    return (
      <div id={this.props.tableid + '-container'} role="content">
        ...
        <div className="widget-body no-padding">
          <div className="dd" style={{maxWidth: '90%'}}>
            <button
              type="button"
